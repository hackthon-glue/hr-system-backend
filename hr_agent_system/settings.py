"""
Django settings for hr_agent_system project.
"""
...
ROOT_URLCONF = 'hr_agent_system.urls'
...
# Only needed for Django Admin and Swagger UI
# For REST API only deployment, these are optional
STATIC_URL = '/static/'
...
# Celery Configuration (Removed - not required for this implementation)
